...
proc customLogicCreateProject {} {
	...
	set files [list \
		...
		"[file normalize "$origin_dir/../02_coaxlink/netlist/axis_data_fifo.dcp"]"\
		"[file normalize "$origin_dir/../02_coaxlink/netlist/clk_wiz_1.dcp"]"\
		...
		"[file normalize "$origin_dir/../02_coaxlink/netlist/gth_cxp_low.dcp"]"\
		...
		"[file normalize "$origin_dir/../02_coaxlink/netlist/sout_fifo.dcp"]"\
	...
	set files [list \
		"[file normalize "$origin_dir/../02_coaxlink/constr/CxlOcto_loc_common.xdc"]"\
		"[file normalize "$origin_dir/../02_coaxlink/constr/CxlOcto_xil_x8_gen3.xdc"]"\
		"[file normalize "$origin_dir/../02_coaxlink/constr/CxlOcto_timing_common.xdc"]"\
